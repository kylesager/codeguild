...
def anagram_checker(word1, word2):
    if(sorted(word1) == sorted(word2)):
        ...
        #the problem i was having earlier was resolved by using "raw_input" instead of input. I'm not sure if this is something you want us doing but it allowedmy code to run on atom...
